...
from fairseq import checkpoint_utils, distributed_utils, options, utils, tasks, scoring
...
def _main(cfg: DictConfig, output_file):
    ...
    if cfg.generation.lm_path is not None:
        ...
        try:
            ...
            logger.warning(
                f"Failed to load language model! Please make sure that " +
                " the language model dict is the same "
    ...
    for sample in progress:
        ...
        for i, sample_id in enumerate(sample["id"].tolist()):
            ...
            if not cfg.common_eval.quiet:
                if src_dict is not None:
                    print("\nSource-{}\t{}".format(sample_id, src_str), file=output_file)
                if has_target:
                    print("Target-{}\t{}".format(sample_id, target_str), file=output_file)
...
def cli_main():
    ...
    override_parser = options.get_generation_parser()
